...
copyright = u'2025, Suriyan Laohaprapanon, Gaurav Sood'
...
latex_documents = [
    (master_doc, 'notnews.tex', u'notnews Documentation',
...
man_pages = [
    (master_doc, 'notnews', u'notnews Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'notnews', u'notnews Documentation',
     author, 'notnews', 'Predict the category of content hosted by a domain.',
     'Miscellaneous'),
]
