...
We use data from NY Times to train a [model](notnews/models/us_not_news_soft_news.ipynb). The function uses the trained model to predict soft news.
...
We use the [model](notnews/models/uk_not_news.ipynb) to predict soft news for UK news media.
