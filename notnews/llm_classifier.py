...
DEFAULT_PROMPT_TEMPLATE = """You are a news categorization expert. Your task is to classify news articles into specific categories based on their content.
...
class LLMNewsClassifier(ABC):
    ...
    def validate_api_key(self) -> bool:
        ...
        if not self.api_key:
            logging.error(f"No API key provided for {self.provider} provider. "
